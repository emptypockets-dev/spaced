            ...
            <li class="bg-white px-4 py-6 shadow sm:rounded-lg sm:px-6">
              <div class="sm:flex sm:justify-between sm:items-baseline">
                <h3 class="text-base font-medium">
                  <span class="text-gray-900">Object Destructuring</span>
                  <span class="text-gray-600">in javascript</span>
                </h3>
                <p class="mt-1 text-sm text-gray-600 whitespace-nowrap sm:mt-0 sm:ml-3">
                  <time datetime="2021-01-27T16:35">Level one</time>
                </p>
              </div>
              <div class="mt-4 space-y-6">
                <iframe
                  src="https://codesandbox.io/embed/object-destructuring-wg01q?fontsize=14&hidenavigation=1&theme=dark"
          ...
          <div class="flex-shrink-0">
            <div class="h-16 bg-white px-6 flex flex-col justify-center">
              <div class="flex items-baseline space-x-3">
                <h2 class="text-lg font-medium text-gray-900">Review Today</h2>
                <p class="text-sm font-medium text-gray-500">10 cards</p>
              </div>
            </div>
            <div
                ...
                <div class="flex justify-between space-x-3">
                  <div class="min-w-0 flex-1">
                    <a href="#" class="block focus:outline-none">
                      ...
                      <p class="text-sm font-medium text-gray-900 truncate">Object Destructuring</p>
                      <p class="text-sm text-gray-500 truncate">Javascript</p>
                    </a>
                  </div>
                  <time
                    datetime="2021-01-27T16:35"
                    class="flex-shrink-0 whitespace-nowrap text-sm text-gray-500">Level one</time
                  >
                </div>
                <div class="mt-1">
                  <p class="line-clamp-2 text-sm text-gray-600">
                    How do you unpack a property from an object and assign it to a variable with a
                    different name?
                  </p>
                </div>
              </li>
              ...
              >
                ...
                <div class="mt-1">
                  <p class="line-clamp-2 text-sm text-gray-600">
                    ...
                    facere. Enim rerum eaque qui facilis. Numquam laudantium sed id dolores omnis
                    in. Eos reiciendis deserunt maiores et accusamus quod dolor.
                  </p>
                </div>
              </li>
